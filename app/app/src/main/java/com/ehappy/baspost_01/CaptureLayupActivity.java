...
public class CaptureLayupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capture_layup);
    ...
    public void changeToUpload(View view){
        ...
        Intent uploadIntent = new Intent(CaptureLayupActivity.this,UploadVideo.class);
        CaptureLayupActivity.this.startActivity(uploadIntent);
    }
